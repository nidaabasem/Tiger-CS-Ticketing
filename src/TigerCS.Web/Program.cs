...
{
    /// <summary>
    /// Entry-point marker so TigerCS.Tests can host this application with
    /// <c>WebApplicationFactory</c>. A named type is used rather than the
    /// generated <c>Program</c> class because TigerCS.Api's own top-level
    /// statements also generate a global <c>Program</c>, and a test project
    /// referencing both assemblies cannot name either unambiguously.
    /// </summary>

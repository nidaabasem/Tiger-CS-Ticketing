...
using TigerCS.Infrastructure.Modules.CrmVerification.Configurations;
using TigerCS.Infrastructure.Modules.IdentityAndAccess.Configurations;

namespace TigerCS.Infrastructure.Persistence;

/// <summary>
/// This increment adds CRM Verification (ADR-0006/0007, MVP-Data-Dictionary.md
/// §2.7/§2.24) and a minimal cross-cutting audit trail (§2.22) on top of
/// Identity and Access (ADR-0004/0005). Ticketing/SLA/Genesys tables are not
/// mapped here yet — those arrive with their own modules' increments.
/// </summary>

...
namespace TigerCS.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260912110119_AddExternalCustomerSnapshotToTickets")]
    partial class AddExternalCustomerSnapshotToTickets
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TigerCS.Domain.Modules.Ticketing.Channel", b =>
                {
                    b.Property<byte>("ChannelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<byte>("ChannelId"));
                    ...
                    b.Property<bool>("IsGenesysEnabled")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("TigerCS.Domain.Modules.Ticketing.Ticket", b =>
                {
                    ...
                    b.Property<string>("ExternalCustomerEmail")
                        .HasMaxLength(256)
            ...
            modelBuilder.Entity("TigerCS.Domain.Modules.Ticketing.TicketInteraction", b =>
                {
                    ...
                    b.Property<string>("GenesysAgentUserId")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
            ...
            modelBuilder.Entity("TigerCS.Infrastructure.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("GenesysEmail")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<string>("GenesysUserId")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.HasIndex(new[] { "GenesysUserId" }, "UX_AspNetUsers_GenesysUserId")
                        .IsUnique()

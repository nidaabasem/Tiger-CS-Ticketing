        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsGeynessStaff = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserDepartmentAssignmentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmployeeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DepartmentId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDepartmentAssignments", x => x.UserDepartmentAssignmentId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserDepartmentAssignments_Employees_EmployeeId",
                        column: x => x.EmployeeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserDepartmentAssignments_EmployeeId_DepartmentId",
                table: "UserDepartmentAssignments",
                columns: new[] { "EmployeeId", "DepartmentId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserDepartmentAssignments_EmployeeId_PrimaryOnly",
                table: "UserDepartmentAssignments",
                column: "EmployeeId",
                unique: true,
                filter: "[IsPrimary] = 1");

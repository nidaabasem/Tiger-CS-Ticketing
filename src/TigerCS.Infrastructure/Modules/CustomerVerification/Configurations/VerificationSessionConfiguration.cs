...
public class VerificationSessionConfiguration : IEntityTypeConfiguration<VerificationSession>
{
    public void Configure(EntityTypeBuilder<VerificationSession> builder)
    {
        ...
        // insert, which CustomerVerificationUnitOfWork translates to
        ...
        // too (see CustomerVerificationUnitOfWork.IsUniqueConstraintViolation's
        // remarks and CustomerVerificationEndpointsTests.CreateVerificationSession_ConcurrentDuplicateRequests_NeitherCallerCrashes's/
        // CrmLookupUpsertConcurrencyTests' remarks) — this index's

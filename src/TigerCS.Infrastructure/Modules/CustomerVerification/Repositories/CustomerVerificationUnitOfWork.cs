...
public sealed class CustomerVerificationUnitOfWork(TigerCsDbContext dbContext) : ICustomerVerificationUnitOfWork
{
    public async Task SaveChangesAsync(CancellationToken cancellationToken = default)
    {
        ...
        catch (DbUpdateException ex) when (IsUniqueConstraintViolation(ex))
        {
            ...
            // and CrmUnitLookupAppService's concurrent-write recovery)
    ...
    /// See CrmLookupUpsertConcurrencyTests' and

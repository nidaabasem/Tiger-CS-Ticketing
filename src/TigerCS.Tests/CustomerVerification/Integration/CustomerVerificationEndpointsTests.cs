...
/// </summary>
public class CustomerVerificationEndpointsTests : IClassFixture<TigerCsApiFactory>
{
    private readonly TigerCsApiFactory _factory;

    public CustomerVerificationEndpointsTests(TigerCsApiFactory factory) => _factory = factory;
    ...
    /// CrmUnitLookupAppService's plain (non-filtered) unique indexes in
    /// CrmLookupUpsertConcurrencyTests — does not enforce a unique

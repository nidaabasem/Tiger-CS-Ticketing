...
public class TicketReconciliationAppServiceTests
{
        ...
        Fixture f, string rawUnitNumberEntered = "1204")
    {
        ...
        var intake = new IntakeRecord(WellKnownChannels.Phone, "+971500000001", null, isUnitRelated: true, rawUnitNumberEntered, priorityHint: null, agentId, DateTime.UtcNow);
